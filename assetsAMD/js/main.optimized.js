...
(function() {
    ...
    var T = x.each = x.forEach = function(e, t, r) {
        ...
        } else for (var o in e) if (x.has(e, o) && t.call
(r, e[o], o, e) === n) return;
    };
...
: t);
    ...
    }, x.first = x.head = x.take = function(e
, t, n) {
...
, i = e.length; r < i; r++) t ? n[e[r]] = t[r] : n[e[r][0]] = e[r][1];
    ...
    x.bind = function(e, t) {
        ...
        return function() {
            ...
            !u && n.leading === !1 && (u = f);
            var l = t - (f - u);
            return r = this, i = arguments, l <= 0 ? (clearTimeout(o), o = null, u = f
, s = e.apply(r, i)) : !o && n.trailing !== !1 && (o = setTimeout(a, l)), s;
        };
...
return t.apply(n, arguments), (e == "shift" || e == "splice") && n.length === 0 && delete n[0], F.call(this, n);
    ...
    define("config/underscore/templatesettings", [ "underscore" ], function(e) {
    ...
    function cloneCopyEvent(e, t) {
        ...
        if (data_priv.hasData(e)) {
            ...
            if (f) {
                ...
                for (i in f) for (n = 0, r = f[i].length; n < r; 
n++) jQuery.event.add(t, i, f[i][n]);
    ...
    function isHidden(e, t) {
        return e = 
t || e, jQuery.css(e, "display") === "none" || !jQuery.contains(e.ownerDocument, e);
    }
    ...
    function inspectPrefiltersOrTransports(e, t, n, r) {
        function o(u) {
            ...
            return i[u] = !0, jQuery.each(e[u] || [], function(e, u) {
                var f = u(t, n, r);
                if (typeof f == "string" && !s && !i[f]) return t.dataTypes
.unshift(f), o(f), !1;
                if (s) return !(a = f);
            }), a;
        }
...
(), n = Math.max(0, f.startTime + f.duration - t), r = n / f.duration || 0, s = 1 - r, o = 0, a = f.tweens.length;
    ...
    jQuery.fn = jQuery.prototype = {
        ...
        init: function(e, t, n) {
            ...
            if (typeof e == "string") {
                ...
                if (r && (r[1] || !t)) {
                    if (r[1]) {
                        t = t instanceof jQuery ? t[0] : 
t, jQuery.merge(this, jQuery.parseHTML(r[1], t && t.nodeType ? t.ownerDocument || t : document, !0));
...
[1]) ] : (r = jQuery.buildFragment([ e ], t, i), i && jQuery(i).remove(), jQuery.merge([], r.childNodes));
        },
        ...
        makeArray: function(e, t) {
            var n = t || [];
            return e != null && (isArraylike(Object(e)) ? jQuery.merge(n, typeof e == "string" ? 
[ e ] : e) : core_push.call(n, e)), n;
        },
            ...
            if (d && !i) {
                ...
                if (r.qsa && (!v || !v.test(e))) {
                    ...
                    if (a === 1 && t.nodeName.toLowerCase() !== "object") {
                        l = vt(e), (p = t.getAttribute("id")) ? m = p.replace(tt, "\\$&") 
: t.setAttribute("id", m), m = "[id='" + m + "'] ", f = l.length;
...
f = bt(g, p), r(f, [], u, a), l = f.length;
        ...
        function St(e, t) {
            var n = 0, r = t.length > 0, o = e.length > 0, u = function(u, a, l, c, p) {
                var d, v, m, g = [], y = 0, b = "0", w = u && [], S = p != null, x = f
, T = u || o && s.find.TAG("*", p && a.parentNode || a), N = E += x == null ? 1 : Math.random() || .1;
                S && (f = a !== h && a, i = n);
                for (; (d = T[b]) != null; b++) {
                    if (o && d) {
                        v = 0;
        ...
        function Tt(e, t, n, i) {
            ...
            if (!i && h.length === 1) {
                ...
                while (o--) {
                    ...
                    if (c = s.find[l]) if (i = c(f.matches[0].replace(nt, rt), V.test(u[0].type
) && t.parentNode || t)) {
...
q = I.replace("w", "w#"), R = "\\[" + F + "*(" + I + ")" + F + "*(?:([*^$|!~]?=)" + F + "*(?:(['\"])((?:\\\\.|[^\\\\])*?)\\3|(" + q + ")|)|)" + F + "*\\]", U = ":(" + I + ")(?:\\(((['\"])((?:\\\\.|[^\\\\])*?)\\3|((?:\\\\.|[^\\\\()[\\]]|" + R.replace(3, 8) + ")*)|.*)\\)|)", z = new RegExp("^" + F + "+|((?:^|[^\\\\])(?:\\\\.)*)" + F + "+$", "g"), W = new RegExp("^" + F + "*," + F + "*"), X = new RegExp("^" + F + "*([>+~]|" + F + ")" + F + "*"), V = new RegExp(F + "*[+~]"), $ = new RegExp("=" + F + "*([^\\]'\"]*)" + F + "*\\]", "g"), J = new RegExp(U), K = new RegExp("^" + q + "$"), Q = {
            ID: new RegExp("^#(" + I + ")"),
            CLASS: new RegExp("^\\.(" + I + ")"),
            TAG: new RegExp("^(" + I.replace("w", "w*") + ")"),
            ATTR: new RegExp("^" + R),
            PSEUDO: new RegExp("^" + U),
            CHILD: new RegExp("^:(only|first|last|nth|nth-last)-(child|of-type)(?:\\(" + F + "*(even|odd|(([+-]|)(\\d*)n|)" + F + "*(?:([+-]|)" + F + "*(\\d+)|))" + F + "*\\)|)"
, "i"),
            bool: new RegExp("^(?:" + j + ")$", "i"),
...
function(e, t) {
            ...
            if (r.qsa = G.test(t.querySelectorAll)) at(function(e) {
                ...
                n.setAttribute
("type", "hidden"), e.appendChild(n).setAttribute("t", ""), e.querySelectorAll("[t^='']").length && v.push("[*^$]=" + F + "*(?:''|\"\")"), e.querySelectorAll(":enabled").length || v.push(":enabled", ":disabled"), e.querySelectorAll("*,:x"), v.push(",.*:");
            });
...
while (r = r.parentNode) a.unshift(r);
            ...
            var i = s.attrHandle[n.toLowerCase()], o = i && O.call(s.attrHandle, n.toLowerCase()) ? i(e, n
, !d) : t;
...
return n;
            ...
            preFilter: {
                ...
                CHILD: function(e) {
                    return e[1] = e[1].toLowerCase(), e[1].slice(0, 3) === "nth" ? (e[3] || st.error(e[0]), e[4] = +(e[4] ? 
e[5] + (e[6] || 1) : 2 * (e[3] === "even" || e[3] === "odd")), e[5] = +(e[7] + e[8] || e[3] === "odd")) : e[3] && st.error(e[0]), e;
                },
                PSEUDO: function(e) {
                    var n, r = !e[5] && e[2];
...
return !!e.parentNode;
                        ...
                        if (m) {
                            ...
                            if (o && y) {
                                ...
                                while (c = ++p && 
c && c[v] || (h = p = 0) || d.pop()) if (c.nodeType === 1 && ++h && c === t) {
                                    l[e] = [ E, p, h ];
                                    break;
                                }
                ...
                PSEUDO: function(e, t) {
                    ...
                    return r[b] ? r(t) : r.length > 1 ? (n = [ e, e, "", t ], s.setFilters.hasOwnProperty
(e.toLowerCase()) ? ut(function(e, n) {
...
;
    ...
    jQuery.Callbacks = function(e) {
        ...
        var t, n, r, i, s, o, u = [], a = !e.once && [], f = function(c) {
            ...
            for (; u && o < s; o++) if (u[o].apply(c[0], c[1]) === !1 && 
e.stopOnFalse) {
                t = !1;
                break;
            }
                    ...
                    return jQuery.Deferred(function(n) {
                        jQuery.each(t, function(t, s) {
                            ...
                            i[s[1]](function() {
                                ...
                                e && jQuery.isFunction(e.promise) ? e.promise().done(n.resolve).fail(n.reject).progress(n.notify) : n[o + "With"](this === r ? n.promise() : this, u ? [ 
e ] : arguments);
                            });
                        }), e = null;
                    }).promise();
...
var t = {}, n = e[this.expando];
        ...
        access: function(e, t, n) {
            var r;
            return t === undefined || t && typeof t == "string" && n === undefined ? (r = this.get(e, t), r !== undefined ? 
r : this.get(e, jQuery.camelCase(t))) : (this.set(e, t, n), n !== undefined ? n : t);
        },
        remove: function(e, t) {
...
: function(e, t) {
        ...
        promise: function(e, t) {
            var n, r = 1, i = jQuery
.Deferred(), s = this, o = this.length, u = function() {
                --r || i.resolveWith(s, [ s ]);
            };
...
.propFix[e] || e];
        ...
        removeClass: function(e) {
            var t, n, r, i, s, o = 0, u = this.length, a = arguments.length === 0 || typeof e == "string" && 
e;
            if (jQuery.isFunction(e)) return this.each(function(t) {
        ...
        toggleClass: function(e, t) {
            ...
            return typeof t == "boolean" && n === "string" ? t ? this.addClass(e) : this.removeClass(e) : jQuery.isFunction(e) ? this.each(function(n) {
                jQuery(this).toggleClass(e.call
(this, n, this.className, t), t);
            }) : this.each(function() {
                if (n === "string") {
        ...
        val: function(e) {
            var t, n, r, i = this[0];
            if (!arguments.length) {
                if (i) return t = jQuery.valHooks[i.type] || jQuery.valHooks[i.
nodeName.toLowerCase()], t && "get" in t && (n = t.get(i, "value")) !== undefined ? n : (n = i.value, typeof n == "string" ? n.replace(rreturn, "") : n == null ? "" : n);
                return;
            }
...
if (s && e.nodeType === 1) while (n = s[i++]) r = jQuery.propFix[n] || n, jQuery.expr.match.bool.test(n) && (e[r] = !1), e.removeAttribute(n);
        ...
        prop: function(e, t, n) {
            ...
            return s = o !== 1 || !jQuery.isXMLDoc(e), s && (t = jQuery.propFix[t] || t, i = jQuery.propHooks[t]), n !== undefined ? i && "set" in i && (r = i.set(e, n, t)) !== undefined ? r : e[t] = n : i && "get" in i && (r = i.get(e, t)) !== null ? 
r : e[t];
        },
        propHooks: {
            tabIndex: {
...
n.handler && (s = n, n = s.handler, i = s.selector), n.guid || (n.guid = jQuery.guid++), (a = m.events) || (a = m.events = {}), (o = m.handle) || (o = m.handle = function(e) {
            ...
            while (f--) {
                ...
                c = jQuery.event.special[p] || {}, p = (i ? c.delegateType : c.bindType) || p, c = jQuery.event.special[p] || {}, l = jQuery.extend({
                    ...
                    guid: n.guid,
                    selector: i,
                    needsContext: i && jQuery.expr.match.needsContext
.test(i),
                    namespace: d.join(".")
        ...
        remove: function(e, t, n, r, i) {
            ...
            while (f--) {
                ...
                c = jQuery.event.special
[p] || {}, p = (r ? c.delegateType : c.bindType) || p, h = a[p] || [], u = u[2] && new RegExp("(^|\\.)" + d.join("\\.(?:.*\\.|)") + "(\\.|$)"), o = s = h.length;
...
()) e.type = i > 1 ? u : l.bindType || h, f = (data_priv.get(s, "events") || {})[e.type] && data_priv.get(s, "handle"), f && f.apply(s, t), f = a && s[a], f && jQuery.acceptData(s) && f.apply && f.apply(s, t) === !1 && e.preventDefault();
...
;
        ...
        handlers: function(e, t) {
            ...
            if (u && a.nodeType && (!e.button || e.type !== "click")) for (; a !== this; a = a.parentNode || this) if (a.disabled !== !0 || e.type !== "click") {
                r = [];
                for (n = 0; n < u; n++) s = t[n], i = s.selector + " ", r[i] === undefined && (r[i] = s.needsContext ? jQuery(i, this).index(a) >= 0 
: jQuery.find(i, this, null, [ a ]).length), r[i] && r.push(s);
                r.length && o.push({
                    elem: a,
                    handlers: r
                });
        ...
        mouseHooks: {
            ...
            filter: function(e, t) {
                ...
                return e.pageX == 
null && t.clientX != null && (n = e.target.ownerDocument || document, r = n.documentElement, i = n.body, e.pageX = t.clientX + (r && r.scrollLeft || i && i.scrollLeft || 0) - (r && r.clientLeft || i && i.clientLeft || 0), e.pageY = t.clientY + (r && r.scrollTop || i && i.scrollTop || 0) - (r && r.clientTop || i && i.clientTop || 0)), !e.which && s !== undefined && (e.which = s & 1 ? 1 : s & 2 ? 3 : s & 4 ? 2 : 0), e;
            }
        },
        fix: function(e) {
        ...
        special: {
            ...
            beforeunload: {
                postDispatch: function(e) {
                    e.result !== undefined && (e.originalEvent
...
, n = s.handler.apply(this, arguments), e.type = t;
        ...
        on: function(e, t, n, r, i) {
            ...
            n == null && r == null ? (r = t, n = t = undefined) : r == null && 
(typeof t == "string" ? (r = n, n = undefined) : (r = n, n = t, t = undefined));
        ...
        off: function(e, t, n) {
            ...
            return n === !1 && 
(n = returnFalse), this.each(function() {
...
(e, r[t], n);
        ...
        closest: function(e, t) {
            ...
            for (; r < i; r++) for (n = this[r]; n && n !== t; n = 
n.parentNode) if (n.nodeType < 11 && (o ? o.index(n) > -1 : n.nodeType === 1 && jQuery.find.matchesSelector(n, e))) {
                n = s.push(n);
                break;
            }
...
this, e);
        ...
        empty: function() {
            var e, t = 0;
            for (; (e = this[t]) != null; t++) e.nodeType === 1 && (jQuery.cleanData(getAll(
e, !1)), e.textContent = "");
            return this;
        },
        clone: function(e, t) {
...
setGlobalEval(o, !a && getAll(e, "script")), u;
        ...
        buildFragment: function(e, t, n, r) {
            ...
            while (i = p[l++]) {
                ...
                a = jQuery.contains
(i.ownerDocument, i), s = getAll(h.appendChild(i), "script"), a && setGlobalEval(s);
                if (n) {
                    f = 0;
...
: 400
    ...
    jQuery.fn.extend({
        ...
        style: function(e, t, n, r) {
            ...
            if (n === undefined) return o && "get" in 
o && (i = o.get(e, !1, r)) !== undefined ? i : a[t];
        ...
        jQuery.cssHooks[t] = {
            ...
            set: function(e, n, r) {
                var i = r && getStyles(e);
                return setPositiveNumber(e, n, r ? augmentWidthOrHeight(e, t, r, jQuery.support.boxSizing && 
jQuery.css(e, "boxSizing", !1, i) === "border-box", i) : 0);
            }
        };
    }), jQuery(function() {
...
jQuery.isPlainObject(e)) jQuery.each(e, function() {
...
e, t, n) {
    ...
    ajaxLocParts = rurl.exec(ajaxLocation.toLowerCase()) || [], jQuery.fn.load = function(e, t, n) {
        ...
        return u >= 0 && (r = e.slice
(u), e = e.slice(0, u)), jQuery.isFunction(t) ? (n = t, t = undefined) : t && typeof t == "object" && (i = "POST"), o.length > 0 && jQuery.ajax({
            url: e,
            type: i,
            dataType: "html",
            data: t
...
: "application/x-www-form-urlencoded; charset=UTF-8",
        ...
        ajaxSetup: function(e, t) {
            return t ? ajaxExtend(ajaxExtend(e, jQuery.ajaxSettings), t) : ajaxExtend
(jQuery.ajaxSettings, e);
        ...
        ajax: function(e, t) {
            function S(e, t, s, u) {
                ...
                w.status = e, w.statusText = (t || S) + ""
, f ? p.resolveWith(c, [ m, S, w ]) : p.rejectWith(c, [ w, S, g ]), w.statusCode(v), v = undefined, a && h.trigger(f ? "ajaxSuccess" : "ajaxError", [ w, l, f ? m : g ]), d.fireWith(c, [ w, S ]), a && (h.trigger("ajaxComplete", [ w, l ]), --jQuery.active || jQuery.event.trigger("ajaxStop"));
            }
...
(l.url = rts.test(r) ? r.replace(rts, "$1_=" + ajax_nonce++) : r + (ajax_rquery.test(r) ? "&" : "?") + "_=" + ajax_nonce++)), l.ifModified && (jQuery.lastModified[r] && w.setRequestHeader("If-Modified-Since", jQuery.lastModified[r]), jQuery.etag[r] && w.setRequestHeader("If-None-Match", jQuery.etag[r])), (l.data && l.hasContent && l.contentType !== !1 || t.contentType) && w.setRequestHeader("Content-Type", l.contentType), w.setRequestHeader("Accept", l.dataTypes[0] && l.accepts[l.dataTypes[0]] ? l.accepts[l.dataTypes[0]] + (l.dataTypes[0] !== "*" ? ", " + allTypes + "; q=0.01" : "") : l.accepts["*"]);
            ...
            if (!l.beforeSend || l.beforeSend.call(c, w, l) !== !1 && y !== 2) {
                ...
                n = inspectPrefiltersOrTransports(transports
, l, t, w);
...
, n = function(e) {
    ...
    jQuery.ajaxSetup({
        ...
        if (o || e.dataTypes[0] === "jsonp") return r = e.jsonpCallback = jQuery.isFunction(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback, o ? e[o] = 
e[o].replace(rjsonp, "$1" + r) : e.jsonp !== !1 && (e.url += (ajax_rquery.test(e.url) ? "&" : "?") + e.jsonp + "=" + r), e.converters["script json"] = function() {
...
xhrSupported && "withCredentials" in xhrSupported, jQuery.support.ajax = xhrSupported = !!xhrSupported, jQuery.ajaxTransport(function(e) {
        var t;
    ...
    var fxNow, timerId, rfxtypes = /^(?:toggle|show|hide)$/, rfxnum = new RegExp("^(?:([+-])=|)(" + core_pnum + ")([a-z%]*)$", "i"), rrun = /queueHooks$/, animationPrefilters = [ defaultPrefilter ], tweeners = {
        "*": [ function(e, t) {
            ...
            if (o && o[3] !== s) {
                s = s || o[3], i = i || [], o = +r || 1;
                do u = u || ".5", o /= u, jQuery
.style(n.elem, e, o + s); while (u !== (u = n.cur() / r) && u !== 1 && --a);
            }
    ...
    jQuery.Animation = jQuery.extend(Animation, {
        ...
        _default: {
            ...
            set: function(e) {
                jQuery.fx.step[e
.prop] ? jQuery.fx.step[e.prop](e) : e.elem.style && (e.elem.style[jQuery.cssProps[e.prop]] != null || jQuery.cssHooks[e.prop]) ? jQuery.style(e.elem, e.prop, e.now + e.unit) : e.elem[e.prop] = e.now;
            }
        }
        ...
        animate: function(e, t, n, r) {
            var i = jQuery.isEmptyObject(e), s = jQuery.speed(t, n, r), o = 
function() {
...
;
        ...
        setOffset: function(e, t, n) {
            ...
            l === "static" && (e.style.position = "relative"), u = c.offset(), s = jQuery.css(e, "top"), a = jQuery.css(e, "left"), f = (l === "absolute" || l === "fixed") && (s + a).indexOf("auto") > -1, f ? (r = c.position(), o = r.top, i = r.left) : (o = parseFloat(s) || 0, i = parseFloat(a) || 0), jQuery.isFunction(t) && (t = t.call(e, n, u)), t.top != null && (h.top = t.top - u.top + o), 
t.left != null && (h.left = t.left - u.left + i), "using" in t ? t.using.call(e, h) : c.css(h);
        }
    }, jQuery.fn.extend({
        position: function() {
            if (!this[0]) return;
...
access(this, function(t, n, r) {
    ...
    typeof exports != "undefined" ? t(e, exports, require("underscore")) : typeof define == "function" && 
define.amd ? define("backbone", [ "underscore", "jquery", "exports" ], function(n, r, i) {
    ...
    var f = t.Events = {
        ...
        once: function(e, t, r) {
            ...
            var i = this, s = n.once(function() {
                i.
off(e, s), t.apply(this, arguments);
            });
...
switch (t.length) {
    ...
    n.each(p, function(e, t) {
        f[t] = function(t, r, i) {
            var s = this._listeners || (this._listeners = {}), o = t._listenerId || (t._listenerId = n.uniqueId("l"));
...
[ "keys", "values", "pairs", "invert", "pick", "omit" ];
    ...
    n.extend(g.prototype, f, {
        ...
        set: function(e, t) {
            ...
            var r, i, s, u, f, l, c = t.at, h = this.comparator && c == null && t.sort !== !1, p = n.isString(this.comparator) ? this.comparator : null, d = [], v = [], m = {};
            for (r = 0, i = e.length; r < i; r++) {
...
if (!(s = this._prepareModel(e[r], t))) continue;
        ...
        reset: function(e, t) {
            t || (t = {});
            for (
var r = 0, i = this.models.length; r < i; r++) this._removeReference(this.models[r]);
...
: this._byId[e.id != null ? e.id : e.cid || e];
        },
        at: function(e) {
...
(t);
    ...
    var w = [ "forEach"
, "each", "map", "collect", "reduce", "foldl", "inject", "reduceRight", "foldr", "find", "detect", "filter", "select", "reject", "every", "all", "some", "any", "include", "contains", "invoke", "max", "min", "toArray", "size", "first", "head", "take", "initial", "rest", "tail", "drop", "last", "without", "indexOf", "shuffle", "lastIndexOf", "isEmpty", "chain" ];
    n.each(w, function(e) {
    ...
    var S = t.View = function(e) {
        this.cid = n.uniqueId("view"), this._configure(e || {}), this._ensureElement(), this.initialize.apply(this, arguments), this
.delegateEvents();
    }, x = /^(\S+)\s*(.*)$/, T = [ "model", "collection", "el", "id", "attributes", "className", "tagName", "events" ];
...
(i || (i = {}), {
        ...
        o.type !== "GET" && !i.emulateJSON && (o.processData = !1), o.type === "PATCH" && 
window.ActiveXObject && (!window.external || !window.external.msActiveXFilteringEnabled) && (o.xhr = function() {
...
return e ? decodeURIComponent(e) : null;
    ...
    M.started = !1, n.extend(M.prototype, f, {
        ...
        start: function(e) {
            ...
            var o = 
this.location, u = o.pathname.replace(/[^\/]$/, "$&/") === this.root;
        ...
        checkUrl: function(e) {
            ...
            t === this.
fragment && this.iframe && (t = this.getFragment(this.getHash(this.iframe)));
        ...
        navigate: function(e, t) {
            ...
            if (this._hasPushState) this.history[t.replace ? "replaceState" : "pushState"]({}, document.title, n); else {
                ...
                this._updateHash
(this.location, e, t.replace), this.iframe && e !== this.getFragment(this.getHash(this.iframe)) && (t.replace || this.iframe.document.open().close(), this._updateHash(this.iframe.location, e, t.replace));
            }
    ...
    } else typeof define == "function" && define.amd && define("backbone.wreqr", [ "underscore", "backbone" ], t);
}(this, function(e, t) {
...
("backbone.babysitter", [ "underscore", "backbone" ], t);
}(this, function(e, t) {
    "option strict";
...
function(e) {
        ...
        var r = [ "forEach", "each", "map", "find", "detect", "filter", "select", "reject", "every"
, "all", "some", "any", "include", "contains", "invoke", "toArray", "first", "initial", "rest", "last", "without", "isEmpty", "pluck" ];
    ...
    if (typeof exports == "object") {
        var n = require("underscore"), r = require("backbone"), i = require("backbone.wreqr"), s = require("backbone.babysitter");
        module.exports = t(n, r, i, s);
    } else typeof define == "function" && define.amd && define("marionette", [ "underscore", "backbone", "backbone.wreqr", "backbone.babysitter" ], t);
}(this, function(e, t) {
...
t || "Error", n;
        ...
        return r.extend = t.Model.extend, r.getOption = function(e, t) {
            ...
            var e = /(^|:)(\w)/gi, r = function(r) {
                var i = "on" + r.replace(e, t), s = this[i];
                n.isFunction(this.trigger) && this.trigger.apply(this, arguments);
                if (n.isFunction(s)) return s.apply(this, n.tail(arguments));
            };
            return r;
...
, t;
            ...
            buildRegion: function(e, t) {
                ...
                if (!o && !r && !i) throw new Error("Region must be specified as a Region type, a selector string or an object with selector property");
                var u, a;
            ...
            show: function(e) {
                ...
                i && this.close(), e.render(), (i || t) && this.open(e), this.currentView = e, r.triggerMethod.call(this, "show", e), r.triggerMethod.call(e, "show");
            },
            ensureEl: function() {
            ...
            close: function() {
                ...
                e.close ? e.close() : e.remove && e.remove(), r.triggerMethod.call(this, "close"), delete this.currentView;
            },
...
this.currentView = e;
            ...
            var t = e.Controller.extend({
                ...
                addRegion: function(t, r) {
                    ...
                    return o || s && u ? i = 
e.Region.buildRegion(r, e.Region) : n.isFunction(r) ? i = e.Region.buildRegion(r, e.Region) : i = r, this._store(t, i), this.triggerMethod("region:add", t, i), i;
                },
                get: function(e) {
        ...
        }(r), r.TemplateCache = function(e) 
{
            ...
            loadTemplate: function(e) {
                var t = r.$(e).html();
                return (!t || t.length === 0) && o("Could not find template: '" + e + "'"
, "NoTemplateError"), t;
            },
            ...
            render: function(e, t) {
                ...
                var i;
                return typeof e == "function" ? i = e : i = r.TemplateCache.get(e), i(t);
            }
...
(e), r.bindEntityEvents(this, this.model, r.getOption(this, "modelEvents")), r.bindEntityEvents(this, this.collection, r.getOption(this, "collectionEvents"));
            },
...
,
            ...
            triggerBeforeRender: function() {
                this.triggerMethod("before:render", this), this.triggerMethod("collection:before:render"
, this);
            },
...
var n = new t.Model;
            ...
            addItemView: function(e, t, i) {
                ...
                this.addChildViewEventForwarding(o), this.triggerMethod("before:item:added", o), this.children.add(o), this.renderItemView(o, i), this._isShown && r.triggerMethod.call(o, "show"), this.triggerMethod("after:item:added", o);
            },
            addChildViewEventForwarding: function(e) {
                var t = 
r.getOption(this, "itemViewEventPrefix");
...
(!this.collection || this.collection.length === 0) && this.showEmptyView();
            ...
            constructor: function() {
                r.CollectionView.prototype.constructor.apply(this, s(arguments));
            },
            _initialEvents: function() {
...
this.collection && (this.listenTo(this.collection, "add", this.addChildView, this), this.listenTo(this.collection, "remove", this.removeItemView, this), this.listenTo(this.collection, "reset", this._renderChildren, this));
            ...
            render: function() {
                ...
                return this.$el.html(e), this.bindUIElements(), this.triggerMethod("composite:model:rendered"), this._renderChildren(), this.triggerMethod("composite:rendered"), this.triggerRendered(), 
this;
            },
            _renderChildren: function() {
            ...
            getItemViewContainer: function(e) {
                ...
                if (i) {
                    ...
                    t = e.$(s), t.length <= 0 && o("The specified `itemViewContainer` was not found: " + e.itemViewContainer
, "ItemViewContainerMissingError");
            ...
            render: function() {
                ...
                var e = Array.prototype.slice.apply(arguments), t = r.ItemView.prototype.render.apply(this, e);
                return t;
            },
            close: function() {
                if (this.isClosed) return;
...
var e = Array.prototype.slice.apply(arguments);
            ...
            _initializeRegions: function(e) {
                var t;
                this._initRegionManager(), n.isFunction
(this.regions) ? t = this.regions(e) : t = this.regions || {}, this.addRegions(t);
            },
...
this.processAppRoutes(i, n);
            ...
            _addAppRoute: function(e, t, r) {
                var i = e[r];
                if (!i) throw new Error("Method '" + r + "' was not found on the controller");
                this.route(t, r, n.bind(i, e));
            }
        }), r.Application = function(e) {
            this._initRegionManager(), this._initCallbacks = new r.Callbacks, this.vent = new t.Wreqr.EventAggregator, this.commands = new t.Wreqr.Commands, this.reqres = new 
t.Wreqr.RequestResponse, this.submodules = {}, n.extend(this, e), this.triggerMethod = r.triggerMethod;
...
._regionManager.closeRegions();
            ...
            this.moduleName = e, this.submodules = {}, this._setupInitializersAndFinalizers(), this.app = t, this.startWithParent = !0, this.triggerMethod = 
r.triggerMethod;
            ...
            stop: function() {
                ...
                this._isInitialized = !1, r.triggerMethod.call(this, "before:stop"), n.each(this.submodules, function(e) {
                    e.stop();
                }), this._finalizerCallbacks.run(undefined, this), this._initializerCallbacks.reset(), this._finalizerCallbacks
.reset(), r.triggerMethod.call(this, "stop");
            },
...
_getModule: function(e, t, n, i, s) {
    ...
    define("config/marionette/templatecache", [ "marionette" ], function(e) {
        return e.TemplateCache.prototype.loadTemplate = function(e) {
            var t, n, r;
            r = e;
            if (!r || r.length === 0) throw n = "Could not find template: '" + e + "'"
, t = new Error(n), t.name = "NoTemplateError", t;
            return r;
        };
    });
}.call(this), function() {
    define("config/marionette/renderer", [ "marionette" ], function(e) {
        return e.Renderer.render = function(e, t) {
            var n;
            n = e;
            if (!n) throw "Template " + e + " not found!";
            return n(t);
        };
    });
}.call(this), function() {
    define("config/marionette/application", [ "marionette", "backbone" ], function(e, t) {
        return _.extend(e.Application.prototype, {
            navigate: function(e, n) {
                return n == null && (n = {}), console.log(e), e.charAt(0) === "/" && (e = "#" + e), t.history.navigate(e, n);
            },
            getCurrentRoute: function() {
                return t.history.fragment;
            }
        });
    });
}.call(this), function() {
    define("config/marionette/view", [ "marionette" ], function(e) {
        return _.extend(e.View.prototype, {
            
templateHelpers: {
                linkTo: function(e, t, n) {
                    return n == null && (n = {}), _.defaults(n, {
                        external: !1
                    }), n.external || (t = "#" + t), "<a href='" + t + "'>" + escape(e) + "</a>";
                }
            }
        });
    });
    ...
    define("config/marionette/region/dialog", [ "backbone", "marionette" ], function(e, n) {
        return n.Region.Dialog = function(n) {
            function r() {
                _.extend(this, e.Events);
            }
            return t(r, n), r.prototype.onShow = function(e) {
                var t, n = this;
                return this.setupBindings(e), t = this.getDefaultOptions
(_.result(e, "dialog")), this.$el.modal(t, {
                    close: function(e, t) {
                        return n.closeDialog();
                    }
                });
            }, r.prototype.getDefaultOptions = function(e) {
                return e == null && (e = {}), _.defaults(e, {
                    show: !0,
                    keyboard: !0
                });
            }, r.prototype.setupBindings = function(e) {
                return this.listenTo(e, "dialog:close", this.closeDialog);
            }, r.prototype.closeDialog = function() {
                return console.log("Marionette.Region.Dialog>> calling in the cleaner!"), this.$el.modal("hide"), this.stopListening(), this.close();
            }, r;
        }(n.Region);
    });
}.call(this), function() {
    define("config/_base", [ "config/underscore/templatesettings", "config/marionette/templatecache", "config/marionette/renderer", "config/marionette/application", "config/marionette/view", "config/marionette/region/dialog" 
], function() {});
}.call(this), function() {
    define("app", [ "backbone", "marionette" ], function(e, t) {
        var n;
        return n = new t.Application, n.addRegions({
            headerRegion: "#header-region",
            mainRegion: "#main-region",
            footerRegion: "#footer-region"
        }), n.rootRoute = "rachas", n.addInitializer(function() {
            return n.execute("footer:show"), n.execute("header:list");
        }), n.on("initialize:after", function(t) {
            e.history.started || e.history.start();
            if (this.getCurrentRoute() === "") return this.navigate(this.rootRoute, {
                trigger: !0
            });
        }), n;
    });
...
define("views/_base", [ "marionette" ], function(e) {
        var n, r, i, s, o, u, a, f;
        return {
            CollectionView: n = function(e) {
                function n() {
                    return o = n.__super__.constructor.apply(this, arguments), o;
                }
                return t(n, e), n;
            }(e.CollectionView),
            CompositeView: r = function(e) {
                function n() {
                    return u = n.__super__.constructor.apply(this, arguments), u;
                }
                return t(n, e), n;
            }(e.CompositeView),
            ItemView: i = function(e) {
                function n() {
                    return a = n.__super__.constructor.apply(this, arguments), a;
                }
                return t(n, e), n;
            }(e.ItemView),
            Layout: s = function(e) {
                function n() {
                    return f = n.__super__.constructor.apply(this, arguments), f;
                }
...
return t(n, e), n;
...
}.call(this), define("text", {
    load: function(e) {
        throw new Error("Dynamic load not allowed: " + e);
    }
}), define("text!apps/footer/show/templates/show_footer.htm", [], function() {
    return '<div id="footer">\r\n    <div class="container">\r\n        <p class="muted">BackboneRails.com - Episode 06 - Demo</p>\r\n    </div>\r\n</div>';
}), function() {
    define("apps/footer/show/templates", [ "require", "text!apps/footer/show/templates/show_footer.htm" ], function(e) {
        return {
            show_footer: e("text!apps/footer/show/templates/show_footer.htm")
        };
    });
}.call(this), function() {
    var e = {}.hasOwnProperty, t = function(t, n) {
    ...
    define("apps/footer/show/views"
, [ "underscore", "views/_base", "apps/footer/show/templates" ], function(e, n, r) {
        var i, s;
        return {
            Footer: i = function(n) {
                function i() {
                    return s = i.__super__.constructor.apply(this, arguments), s;
                }
                return t(i, n), i.prototype.template = e.template(r.show_footer), i;
            }(n.ItemView)
        };
    });
}.call(this), function() {
    define("apps/footer/show/controller", [ "app", "apps/footer/show/views" ], function(e, t) {
        return {
            showFooter: function() {
                var t;
                return t = this.getFooterView(), e.footerRegion.show(t);
            },
    ...
    define("apps/footer/app", [ "marionette", "apps/footer/show/controller", "app" ], function(e, t, n) {
        var r;
        return r = {
            showFooter
: function() {
        ...
        }, n.commands.setHandler("footer:show", function() {
            return r.showFooter();
        });
    });
}.call(this), define("text!apps/header/list/templates/headers.htm", [], function() {
    return '<div id="header" class="navbar">\n	<div class="navbar-inner">\n		<div class="container">\n			<div class="row">\n				<div class="pull-left">\n					<span class="brand">Analizador Rachas</span>\n				</div>\n				<ul class="nav pull-right"></ul>\n			</div>\n		</div>\n	</div>\n</div>';
}), define("text!apps/header/list/templates/_header.htm", [], function() {
    return "{{ linkTo ( name, url ) }}";
}), function() {
    define("apps/header/list/templates", [ "require", "text!apps/header/list/templates/headers.htm", "text!apps/header/list/templates/_header.htm" ], function(e) {
        return {
            headers: e("text!apps/header/list/templates/headers.htm"),
            _header: e("text!apps/header/list/templates/_header.htm"
)
        };
    });
}.call(this), function() {
    ...
    define("apps/header/list/views", [ "underscore", "views/_base", "apps/header/list/templates" ], function(e, n, r) {
        var i, s, o, u;
        return {
            Header: i = function(n) {
                function i() {
                    return o = i.__super__.constructor.apply(this, arguments), o;
                }
                return t(i, n), i.prototype.template = e.template(r._header), i.prototype.tagName = "li", i;
            }(n.ItemView),
            Headers: s = function(n) {
                function s() {
                    return u = s.__super__.constructor.apply(this, arguments), u;
                }
                return t(s, n), s.prototype
.template = e.template(r.headers), s.prototype.id = "headerList", s.prototype.itemView = i, s.prototype.itemViewContainer = "ul", s;
            }(n.CompositeView)
        };
    });
}.call(this), function() {
    define("apps/header/list/controller", [ "app", "apps/header/list/views" ], function(e, t) {
        return {
            listHeader: function() {
                var t, n;
                return n = e.request("header:entities"), t = this.getHeaderView(n), e.headerRegion.show(t);
            },
            getHeaderView: function(e) {
                return new t.Headers({
                    collection: e
                });
            }
        };
    ...
    define("entities/header"
, [ "backbone", "app" ], function(e, n) {
        var r, i, s, o, u;
        return i = function(e) {
            function n() {
                return o = n.__super__.constructor.apply(this, arguments), o;
            ...
            return t(n, e), n;
        }(e.Model), s = function(e) {
            function n() {
                return u = n.__super__.constructor.apply(this, arguments), u;
            }
            return t(n, e), n.prototype.model = i, n;
        }(e.Collection), n.reqres.setHandler("header:entities", function() {
            return r.getHeaderEntities();
        }), r = {
    ...
    define("apps/header/app", [ "marionette", "apps/header/list/controller"
, "app", "entities/header" ], function(e, t, n) {
        var r;
        return r = {
            listHeader: function() {
                return t.listHeader();
            }
        }, n.commands.setHandler("header:list", function() {
            return r.listHeader();
        });
    });
}.call(this), define("text!apps/rachas/list/templates/list_layout.htm", [], function() {
    return '<div id="botonera"></div>\r\n<div id="tablaRachas"></div>\r\n';
}), define("text!apps/rachas/list/templates/list_botonera.htm", [], function() {
    return "Panel de botones";
}), define("text!apps/rachas/list/templates/rachas.htm", [], function() {
    return '<table class="table table-striped table-bordered">\r\n    <thead class="masthead">\r\n    <tr>\r\n        <th>Equipo</th>\r\n        <th>victoria</th>\r\n        <th>empate</th>\r\n        <th>derrota</th>\r\n    </tr>\r\n    </thead>\r\n    <tbody></tbody>\r\n</table>\r\n';
}), define("text!apps/rachas/list/templates/racha.htm", [], function() 
{
    return "<td>{{equipo}}</td>\r\n<td>{{victoria}} </td>\r\n<td>{{empate}}</td>\r\n<td>{{derrota}}</td>\r\n\r\n";
}), define("text!apps/rachas/list/templates/vacio.htm", [], function() {
    return "vacio";
}), function() {
    define("apps/rachas/list/templates", [ "require", "text!apps/rachas/list/templates/list_layout.htm", "text!apps/rachas/list/templates/list_botonera.htm", "text!apps/rachas/list/templates/rachas.htm", "text!apps/rachas/list/templates/racha.htm", "text!apps/rachas/list/templates/vacio.htm" ], function(e) {
        return {
            list_layout: e("text!apps/rachas/list/templates/list_layout.htm"),
            list_botonera: e("text!apps/rachas/list/templates/list_botonera.htm"),
            rachas: e("text!apps/rachas/list/templates/rachas.htm"),
            racha: e("text!apps/rachas/list/templates/racha.htm"),
            vacio: e("text!apps/rachas/list/templates/vacio.htm")
        };
    });
}.call(this), function() {
    var e = {}.hasOwnProperty, t = function(
t, n) {
        function i() {
            this.constructor = t;
        }
    ...
    define("apps/rachas/list/views", [ "underscore", "views/_base", "apps/rachas/list/templates" ], function(e, n, r) {
        var i, s, o, u, a, f, l, c, h, p;
        return {
            Layout: s = function(n) {
                function i() {
                    return f = i.__super__.constructor.apply(this, arguments), f;
                }
                return t(i, n), i.prototype.template = e.template(r.list_layout), i.prototype.regions = {
                    botonera: "#botonera",
                    tablaRachas: "#tablaRachas"
                }, i;
            }(n.Layout),
            Botonera: i = function(n) {
                function i() {
                    return l = i.__super__.constructor.apply(this, arguments), l;
                }
                
return t(i, n), i.prototype.template = e.template(r.list_botonera), i;
            }(n.ItemView),
            Racha: o = function(n) {
                function i() {
                    return c = i.__super__.constructor.apply(this, arguments), c;
                }
                return t(i, n), i.prototype.template = e.template(r.racha), i.prototype.tagName = "tr", i;
            }(n.ItemView),
            Vacio: a = function(n) {
                function i() {
                    return h = i.__super__.constructor.apply(this, arguments), h;
                }
                return t(i, n), i.prototype.template = e.template(r.vacio), i.prototype.tagName = "tr", i;
            }(n.ItemView),
            TablaRachas: u = function(n) {
                function i() {
                    return p = i.__super__.constructor.apply(this, arguments), p;
                }
                return t(i, n), i.prototype.template = e.template(r.rachas), i.prototype.itemView = o, i.prototype.emptyView = 
a, i.prototype.itemViewContainer = "tbody", i;
            }(n.CompositeView)
        };
    });
}.call(this), function() {
    define("apps/rachas/list/controller", [ "app", "apps/rachas/list/views" ], function(e, t) {
        return {
            getLayoutView: function() {
                return new t.Layout;
            },
            listRachas: function(t) {
                var n, r, i = this;
                return r = e.request("racha:entities"), n = e.request("racha_by_id:entities", t), console.log(r), this.layout = this.getLayoutView(), this.layout.on("show", function() {
                    return i.showBotonera(n), i.showTablaRachas(n);
                }), e.mainRegion.show(this.layout);
            },
            showBotonera: function(e) {
                var t;
                return t = this.getBotonera(e), this.layout.botonera.show(t);
            },
            getBotonera: function(e) {
                return new t.Botonera({
                    collection: e
                
});
            },
            showTablaRachas: function(e) {
                var t;
                return t = this.getTablaRachas(e), this.layout.tablaRachas.show(t);
            },
            getTablaRachas: function(e) {
                return new t.TablaRachas({
                    collection: e
                });
            }
        };
    ...
    define("entities/racha", [ "backbone", "app" ], function(e, n) {
        var r, i, s, o, u;
        return i = function(e) {
            function n() {
                return o = n.__super__.constructor.apply(this, arguments), o;
...
return u = n.__super__.constructor.apply(this, arguments), u;
            ...
            return t(n, e), n.prototype.model = i, n.prototype.url = "/DatosRachas", n;
        }(e.Collection), n.reqres.setHandler("racha:entities", function() {
            return r.getRachasEntities();
        }), n.reqres.setHandler("racha_by_id:entities", function(e) {
            return r.getRacha(e);
        }), r = {
            getRacha: function(e) {
                var t;
                return t = new s, t.fetch(), t.get(e);
            },
            getRachasEntities: function() {
                var e;
                return e = new s, e.fetch(), e;
            }
        };
    });
}.call(this), function() {
    ...
    define("apps/rachas/app"
, [ "marionette", "apps/rachas/list/controller", "app", "entities/racha" ], function(e, n, r) {
        var i, s, o;
        return s = function(e) {
            function n() {
                return o = n.__super__.constructor.apply(this, arguments), o;
            }
            return t(n, e), n.prototype.appRoutes = {
                rachas: "listRachas",
                "rachas2/:id": "showRacha"
            }, n;
        }(e.AppRouter), r.addInitializer(function() {
            return new s({
                controller: i
            });
        }), i = {
            ...
            showRacha: function(e) {
                return console.log(racha), n.listRachas(e);
            }
        };
    });
}.call(this), function() {
...
,
    ...
    }, require([ "config/_base", "app", "apps/footer/app", "apps/header/app", "apps/rachas/app" ], function(e, t) {
        return t.start();
    }));
